...
namespace faspi
{
    ...
    {       
        ...
        public void voucherprint(System.Windows.Forms.Form frm, int Rtype, string vid, String copytype, Boolean stationary, string Mode)
        {
            ...
            //DtFirm.Columns.Add("Name", typeof(string));
            //DtFirm.Columns.Add("CompanyMobileno", typeof(string));
            //DtFirm.Columns.Add("AccountNo", typeof(string));
            //DtFirm.Columns.Add("IFSC", typeof(string));
            //DtFirm.Columns.Add("BankName", typeof(string));
            //DtFirm.Columns.Add("CompanyLandline", typeof(string));
            //DtFirm.Columns.Add("Address1", typeof(string));
            //DtFirm.Columns.Add("Address2", typeof(string));
            //DtFirm.Columns.Add("CompanyEmail", typeof(string));
            //DtFirm.Columns.Add("Tin_no", typeof(string));
            //DtFirm.Columns.Add("CompanyState", typeof(string));
            //DtFirm.Columns.Add("Statecode", typeof(string));

            //DtFirm.Rows.Add();
            //DtFirm.Rows[0]["Name"] = "";
            //DtFirm.Rows[0]["CompanyMobileno"] = "";
            //DtFirm.Rows[0]["AccountNo"] = "";
            //DtFirm.Rows[0]["IFSC"] = "";
            //DtFirm.Rows[0]["BankName"] = "";
            //DtFirm.Rows[0]["CompanyLandline"] = "";
            //DtFirm.Rows[0]["Address1"] = "";
            //DtFirm.Rows[0]["Address2"] = "";
            //DtFirm.Rows[0]["CompanyEmail"] = "";
            //DtFirm.Rows[0]["Tin_no"] = "";
            //DtFirm.Rows[0]["CompanyState"] = "";
            //DtFirm.Rows[0]["Statecode"] = "";
            ...
            if (Gtype == "Stock Transfer" || Gtype == "Challan" || Gtype == "Booking" || Gtype == "Return" || Gtype == "Purchase" || Gtype == "P Return" || Gtype == "Temp" || Gtype == "Purchase" || Gtype == "Pending" || Gtype == "RCM" || Gtype == "Transfer" || Gtype == "Sale" || Gtype == "Delivery")
            {
