...
namespace faspi
{
    ...
    class Database
    {
        public static DateTime ExeDate = DateTime.Parse("09-Nov-2019");
        ...
        public static void setVariable(String fnm, String fyr, String unm, String upss, String utyp, String dbName, DateTime dt1, DateTime dt2,int uid)
        {
            fname = fnm;
            fyear = fyr;
            uname = unm;
