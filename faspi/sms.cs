...
namespace faspi
{
    class sms
    {
        ...
        private void BackgroundWorkerDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            String address = "http://216.245.209.132/rest/services/sendSMS/sendGroupSms?AUTH_KEY=" + AuthKey + "&message=" + gmatter + "%0A" + Footer + "&senderId=" + SenderID + "&routeId=1&mobileNos=" + gph + "&smsContentType=english";
